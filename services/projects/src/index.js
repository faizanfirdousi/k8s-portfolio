...
const { metricsPanelCss, renderMetricsPanel, renderPageToolbar, themeToggleScript } = require('./metrics-panel');
...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .subtitle { color: var(--muted); margin-bottom: 2.5rem; font-size: 1rem; line-height: 1.6; }
    .github-link { color: var(--accent); text-decoration: none; font-weight: 600; }
...
<body>
  <div class="container">
    <div class="page-layout">
      <div class="page-main">
    ${renderPageToolbar('projects')}
    <div class="pod-badge"><div class="dot"></div>Served by <code data-live="pod-name">projects-*</code> pod in <code>ns/projects</code></div>
    <h1>Projects</h1>
    <p class="subtitle">
      Open-source work and side projects. Browse my repositories on
      <a href="https://github.com/${safeUsername}" class="github-link" target="_blank" rel="noopener noreferrer">GitHub</a>.
    </p>
